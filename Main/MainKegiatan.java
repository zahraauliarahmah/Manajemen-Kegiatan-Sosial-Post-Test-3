...
public class MainKegiatan {
    public static void main(String[] args) {
        ...
        System.out.println("Selamat datang di Sistem Manajemen Kegiatan Sosial v2.0!");
        System.out.println("Sistem ini menerapkan konsep OOP: Inheritance, Encapsulation, dan Polymorphism");
        ...
        while (pilih != 6) {
            ...
            if (in.hasNextInt()) {
                ...
                if (pilih == 1) {
                    ...
                    System.out.println("   - Polymorphism: instanceof checks");
